...
// â”€â”€â”€ Pantallas de cada pestaÃ±a â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Row(children: [
          Expanded(child: _TarjetaPuntaje(titulo: 'Aspirantes', valor: '8',  icono: Icons.dns,          color: cs.primaryContainer)),
          const SizedBox(width: 8),
          Expanded(child: _TarjetaPuntaje(titulo: 'Alertas',    valor: '3',  icono: Icons.notifications, color: cs.errorContainer)),
        ]),
        const SizedBox(height: 8),
        Row(children: [
          Expanded(child: _TarjetaPuntaje(titulo: 'Uptime',   valor: '99.8%', icono: Icons.trending_up, color: cs.tertiaryContainer)),
          const SizedBox(width: 8),
          Expanded(child: _TarjetaPuntaje(titulo: 'TrÃ¡fico',  valor: '4.2 GB', icono: Icons.wifi,       color: cs.secondaryContainer)),
        ]),
      ],
    );
  }
...
class _PantallaAspirantes extends StatelessWidget {
  const _PantallaAspirantes();
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) => Card(
        child: ListTile(
          ...
          subtitle: Text('10.0.2.${i + 10} Â· Activo'),
...
class _PantallaAlertas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const alertas = [
      (aspirante: 'Maria Gomez',  mensaje: 'Matematicas > 90%',         nivel: 'CRÃTICO'),
      (aspirante: 'prod-web-03', mensaje: 'Disco al 85%',      nivel: 'AVISO'),
      (aspirante: 'prod-api-02', mensaje: 'Reinicio inesperado', nivel: 'CRÃTICO'),
    ];
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) {
        ...
        final esCritico = alerta.nivel == 'CRÃTICO';
